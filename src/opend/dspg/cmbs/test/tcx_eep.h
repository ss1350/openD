...
typedef struct
{
	...
	u8 m_SUBSDATA_EX[CMBS_PARAM_SUBS_DATA_EX_LENGTH];
	u8 m_AUTH_PIN[CMBS_PARAM_PIN_CODE_LENGTH];
	u8 m_RVREF[CMBS_PARAM_RVREF_LENGTH];
	u8 m_GFSK[CMBS_PARAM_GFSK_LENGTH];
	u8 m_ULENextTPUI[CMBS_PARAM_HAN_ULE_NEXT_TPUI_LENGTH];
} CMBS_EEPROM_DATA;
