 ...
 *
 * Input file: c:\DSPG\cmbs_v250\projects\1029\trunk\ext\dspg\scorpion4\ft-com\bsd09ddl.ddp 
 */
 ...
 * -------------------------------------------------------------------
 * tcmc_asa 26-Feb-2010 E27.68   merged E27.66.1.1 and E27.67
 * rrlingam 25-Feb-2010 E27.66.1.1 Changes for Incoming call during HS LOC
 * tcmc_asa 25-Feb-2010 E27.67  added CSM_DISCONNECT_EXP
 * bhaskarm 15-Feb-2010 E27.66  added HS LoC Reject and Release Ind event
 * rrlingam   09-Feb-2010 E27.65  added new event MI_HSLOC_ALERT_IND
 * hemanthk 03-Feb-2010 E27.64 Merge BLRD53#E27.63 and E27.63
 * hemanthk 03-Feb-2010 E27.63 HS Locator changes for Hs mask as param 
 * tcmc_asa 30-Jan-2010 E27.63  added CSM_CONTROL_CMD_CFM and 
 *                              CMBS_TEST_CALL_BACK
 * hemanthk 28-Jan-2010 E27.62  USB Stack integrated to Octopus for FWUP
 * tcmc_asa 21-Jan-2010 E27.61  added CM_DROP_HS_FROM_INC_CALL
...
#define FTMI_INC_CALL_ON_HSLOC_TMR    (4*SD09_CLOCK_TICKS_PER_SEC)
...
#define CM_DROP_HS_FROM_INC_CALL                  23  	/* = 0x17 */
#define CM_CALLBACK_REQ                           24  	/* = 0x18 */
#define CM_CHANGE_ALERT_REQ                       25  	/* = 0x19 */
#define CM_CH_LINE_REQ                            26  	/* = 0x1a */
#define CM_CALLBACK_EXPIRED_REQ                   27  	/* = 0x1b */
#define CM_CALLBACK_RELEASE_REQ                   28  	/* = 0x1c */
#define CM_SPLIT_LINES_REQ                        29  	/* = 0x1d */
#define CM_SWITCH_LINE_REQ                        30  	/* = 0x1e */
#define CM_CONNECT_DTAM_REQ                       31  	/* = 0x1f */
#define CM_CC_CDC_NEGO_IND                        32  	/* = 0x20 */
#define CM_CC_MODIFY_IND                          33  	/* = 0x21 */
#define CM_CC_MODIFY_CFM                          34  	/* = 0x22 */
#define CM_CC_MOD_CHNG_IND                        35  	/* = 0x23 */
#define CM_CC_CFM_CODEC_IND                       36  	/* = 0x24 */
#define CM_TRIG_SER_CHNG_REQ                      37  	/* = 0x25 */
#define CM_CC_TRANS_TIMED_OUT                     38  	/* = 0x26 */
#define TTS_CM_END                                39  	/* = 0x27 */
#define LDS_CALL_REQ                              40  	/* = 0x28 */
#define SS_FACILITY_CFM                           41  	/* = 0x29 */
#define SS_FACILITY_IND                           42  	/* = 0x2a */
#define LA_SERVICE_RELEASE_REQ                    43  	/* = 0x2b */
#define MM_CODEC_IND                              44  	/* = 0x2c */
#define MM_IWU_INFO_IND                           45  	/* = 0x2d */
#define MM_TERM_CAP_IND                           46  	/* = 0x2e */
#define MNCM_IWU_INFO_REQ                         47  	/* = 0x2f */
#define CC_SETUP_IND                              48  	/* = 0x30 */
#define CC_CALL_IND                               49  	/* = 0x31 */
#define CC_CONNECT_IND                            50  	/* = 0x32 */
#define CC_CALL_PROC_IND                          51  	/* = 0x33 */
#define CC_ALERT_IND                              52  	/* = 0x34 */
#define CC_INFO_IND                               53  	/* = 0x35 */
#define CC_IWU_INFO_IND                           54  	/* = 0x36 */
#define CS_RELEASE_IND                            55  	/* = 0x37 */
#define SS_CS_FACILITY_IND                        56  	/* = 0x38 */
#define MM_CS_CODEC_IND                           57  	/* = 0x39 */
#define CC_SER_CHNG_IND                           58  	/* = 0x3a */
#define CC_SER_CHNG_RES                           59  	/* = 0x3b */
#define CC_UNKNOWN                                60  	/* = 0x3c */
#define PS_CALL_REQ                               61  	/* = 0x3d */
#define PS_CALL_CFM                               62  	/* = 0x3e */
#define PS_RELEASE_REQ                            63  	/* = 0x3f */
#define CM_CC_CHECKCM_IND                         64  	/* = 0x40 */
#define CM_CC_ALERT_IND                           65  	/* = 0x41 */
#define CM_CC_RELEASE_IND                         66  	/* = 0x42 */
#define CM_CC_SETUP_IND                           67  	/* = 0x43 */
#define CM_CC_CONNECT_IND                         68  	/* = 0x44 */
#define CM_CC_DIAL_IND                            69  	/* = 0x45 */
#define CM_CC_CALL_INFO_IND                       70  	/* = 0x46 */
#define CM_CC_CALL_PROC_IND                       71  	/* = 0x47 */
#define CM_CC_UPDATE_CALL_STATE_IND               72  	/* = 0x48 */
#define CM_IDLE_TIMER_EXPIRED                     73  	/* = 0x49 */
#define MI_HS_LOCATOR_REQ                         74  	/* = 0x4a */
#define MI_HS_LOCATOR_REL                         75  	/* = 0x4b */
#define MI_CALL_PROC_REQ                          76  	/* = 0x4c */
#define MI_CALL_ALERT_REQ                         77  	/* = 0x4d */
#define MI_CALL_CONNECT_REQ                       78  	/* = 0x4e */
#define MI_CALL_STATUS_UPDATE_REQ                 79  	/* = 0x4f */
#define MI_CMBS_CALL_REDIRECT                     80  	/* = 0x50 */
#define CSM_CONTROL_CMD_CFM                       81  	/* = 0x51 */
#define CMBS_TEST_CALL_BACK                       82  	/* = 0x52 */
#define CSM_DISCONNECT_EXP                        83  	/* = 0x53 */
...
PUBLIC u8 const * const G_pu8_os09_EventNames_0[]
 ...
 = {
    ...
    (u8 const *)"CM_DROP_HS_FROM_INC_CALL",
    ...
    (u8 const *)"CSM_CONTROL_CMD_CFM",
    (u8 const *)"CMBS_TEST_CALL_BACK",
    (u8 const *)"CSM_DISCONNECT_EXP",
    (u8 const *) 0
}
#endif
;
...
#define MI_HSLOC_ALERT_IND                       207  	/* = 0xcf */
#define MI_HSLOC_ANSWER_IND                      208  	/* = 0xd0 */
#define MI_HSLOC_REJECT_IND                      209  	/* = 0xd1 */
#define MI_HSLOC_RELEASE_IND                     210  	/* = 0xd2 */
#define MI_INC_CALL_ON_HSLOC_EXP                 211  	/* = 0xd3 */
...
PUBLIC u8 const * const G_pu8_os09_EventNames_11[]
 ...
 = {
    ...
    (u8 const *)"MI_HSLOC_ALERT_IND",
    (u8 const *)"MI_HSLOC_ANSWER_IND",
    (u8 const *)"MI_HSLOC_REJECT_IND",
    (u8 const *)"MI_HSLOC_RELEASE_IND",
    (u8 const *)"MI_INC_CALL_ON_HSLOC_EXP",
    (u8 const *) 0
}
#endif
;
...
#define CMBS_TASK_TIMED_REL_LINE                  10  	/* = 0x0a */
#define CMBS_TASK_STOP_SPLASH_RING                11  	/* = 0x0b */
